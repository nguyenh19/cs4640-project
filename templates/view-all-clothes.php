                    ...
                    <table class="table table-striped table-dark">
                        ...
                        <?php
                                ...
                                foreach($clothes as $piece) {
                                    $image = $piece["picture"];
                                    echo "<tr><td>" . $piece["category"] . "</td><td>" . $piece["name"] . "</td><td><input type='image' src='{$image}' alt='./images/high_squidward.png' class='img-fluid hi' style = 'width:200px; height:200px;' alt='image'></td><td>" . $piece["color"] . "</td><td>" . $piece["brand"] . "</td><td><form id='form1' method='post' action='?command=delete-from-closet'>
