            ...
            <div class="card-body">
                <form id="add-piece" action="?command=add-to-closet" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="imgURL" class="form-control" class = "form-control" name="imgURL" placeholder="Insert Image URL Here" required>
                    </div>
                    <div class="form-group" style= "display:none">
                        <label for="file">Item Upload</label>
                        <input type="file" id="file" onchange="return validateFile();" name="file" placeholder="File">
                        <div id="file-msg"></div>
                    </div>
                    <div class="centered-container">
                        <p style = "text-align: left"> To obtain a URL of your desired image try a quick Google search, right click on an image, and click "Copy image address" <br> (**NOTE: UPLOAD IMAGE WITH WHITE BACKGROUND**) </p>
