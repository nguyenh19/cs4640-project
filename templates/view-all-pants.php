    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            async function loadPage(search="") {
                ...
                ajax.open("GET", "?command=Pants", true);
            ...
            function displayShirts(data) {
                var list = document.getElementById("pants-list");
                data.forEach((shirt) => {
            ...
            function setCategory() {
                localStorage("category", JSON.stringify({"category": "pants"}));
            }
        </script>
    </head>
    <body>
        <nav id = "navbar-ex" class="navbar fixed-top navbar-expand-lg navbar-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav ms-auto">
                  ...
                  <a class="nav-link" href="#CLOSET">MY WARDROBE</a>
                  </li>
                  <li class="nav-item">
                ...
                <h1 class = "mycloset d-flex justify-content-center">MY PANTS</h1>
                ...
                <div class="container wadrobeSelection">
                    <div class="row row-cols-md-1 row-cols-md-2 row-cols-md-3 imgs" id="pants-list">
