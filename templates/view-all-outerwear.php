        ...
        <script type="text/javascript">
            ...
            async function loadPage(search="") {
                if (!activeSearch) {
                    ...
                    ajax.open("GET", "?command=Outwerwear", true);
            ...
            function displayShirts(data) {
                var list = document.getElementById("outerwear-list");
                data.forEach((shirt) => {
            ...
            async function search() {
                // debugger;
                var list = document.getElementById("outwerwear-list");
                list.innerHTML = "";
                var data;
                var ajax = new XMLHttpRequest();
                ajax.responseType = "json";
        ...
        <nav id = "navbar-ex" class="navbar fixed-top navbar-expand-lg navbar-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav ms-auto">
                  ...
                  <a class="nav-link" href="?wardrobe">MY WARDROBE</a>
                  </li>
                  <li class="nav-item">
                ...
                <h1 class = "mycloset d-flex justify-content-center">MY OUTERWEAR</h1>
                ...
                <div class="container wadrobeSelection">
                    <div class="row row-cols-md-1 row-cols-md-2 row-cols-md-3 imgs" id="outerwear-list">
