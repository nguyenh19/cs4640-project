        ...
        <script type="text/javascript">
            ...
            async function loadPage(search="") {
                if (!activeSearch) {
                    ...
                    ajax.open("GET", "?command=Shirt", true);
            ...
            function displayShirts(data) {
                var list = document.getElementById("shirt-list");
                data.forEach((shirt) => {
            ...
            function setCategory() {
                localStorage.setItem("category", JSON.stringify({"category": "shirts"}));
            }
        </script>
    </head>
    <body>
        <nav id = "navbar-ex" class="navbar fixed-top navbar-expand-lg navbar-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav ms-auto">
                ...
                <h1 class = "mycloset d-flex justify-content-center">MY SHIRTS</h1>
                ...
                <div class="container wadrobeSelection">
                    <div class="row row-cols-md-1 row-cols-md-2 row-cols-md-3 imgs" id="shirt-list">
